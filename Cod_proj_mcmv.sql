...
-- Nenhuma constraint (PRIMARY KEY, FOREIGN KEY, etc.) é afetada, a menos que o índice seja parte de uma constraint (não é o caso aqui)
...
-- Visualizando a média geral da renda familiar das contratações de financiamento com FGTS: 3046.358662
